...
//
//
//    public Boolean addMessagePush(MessageVO messageVO) throws DbException {
...
//        Boolean result = DBHelper.db.saveBindingId(messageVO);
//        return result;
//    }
//
//    public List<MessageVO> findMessagePush(int start, int limit) throws DbException {
...
//
//        List<MessageVO> messages = DBHelper.db.selector(MessageVO.class)
...
//        int result = DBHelper.db.delete(MessageVO.class, whereBuilder);
//        return result;
//    }
//
//    public void clearMessagePush() throws DbException {
//        DBHelper.db.delete(MessageVO.class);
//    }
//}
